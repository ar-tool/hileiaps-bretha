...
void main()
{
    ...
    // Transform the normal, tangent and binormals to ar_view space.
    ...
    vec3 eyevec = normalize(eyepos - gl_Position.xyz);
	mat3 transposeWorldViewMatrix = mat3(u_worldViewProjectionMatrix[0].xyz, u_worldViewProjectionMatrix[1].xyz, u_worldViewProjectionMatrix[2].xyz);
	vec3 norm = normalize(transposeWorldViewMatrix * normal);
